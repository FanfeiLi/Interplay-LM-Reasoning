#!/bin/bash
# =============================================================================
# Evaluate a single Mamba checkpoint on GSM-Infinity (pass@128)
# =============================================================================
# Usage:
#   bash lingua/apps/mamba/gsm_infinity/run_eval.sh <ckpt_dir> <output_dir> [n_samples]
#
# Example:
#   bash lingua/apps/mamba/gsm_infinity/run_eval.sh \
#       lingua/saves/gsm_infinity/mamba_400M_gsm_.../checkpoints/0000005000 \
#       results/mamba_eval/mamba_400M_gsm_.../checkpoint-5000
# =============================================================================
