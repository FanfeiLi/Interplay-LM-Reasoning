#!/bin/bash
# =============================================================================
# FineWeb-Edu Pre-training — MTP (Multi-Token Prediction) Transformer (lingua)
# =============================================================================
# Usage:
#   bash lingua/apps/mtp/configs_fineweb/run_pretrain.sh 100M
#   bash lingua/apps/mtp/configs_fineweb/run_pretrain.sh 200M
#   bash lingua/apps/mtp/configs_fineweb/run_pretrain.sh 400M
#
...
echo "=============================================="
echo "FineWeb-Edu Pre-training — MTP ${SIZE}"
echo "=============================================="
