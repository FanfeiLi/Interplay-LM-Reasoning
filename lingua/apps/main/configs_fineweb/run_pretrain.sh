#!/bin/bash
# =============================================================================
# FineWeb-Edu Pre-training — Qwen2-style Transformer (lingua)
# =============================================================================
# Usage:
#   bash lingua/apps/main/configs_fineweb/run_pretrain.sh 100M
#   bash lingua/apps/main/configs_fineweb/run_pretrain.sh 200M
#   bash lingua/apps/main/configs_fineweb/run_pretrain.sh 400M
#
...
CONFIG="${SCRIPT_DIR}/llama_${SIZE}_fineweb.yaml"
RUN_NAME="llama_${SIZE}_fineweb_$(date +%Y%m%d_%H%M%S)"
...
echo "=============================================="
echo "FineWeb-Edu Pre-training — Transformer ${SIZE}"
echo "=============================================="
