...
using the MDLMTrainer from dLLM.
...
- 1 Node, 8 GPUs:
    sbatch --gres=gpu:8 scripts/train.slurm.sh \
        ...
        --script_path "examples/gsm_infinity/pt_mdlm.py"
"""
...
class TrainingArguments(dllm.core.trainers.MDLMConfig):
    ...
    # Batch size: target ~1M tokens/step on 8 GPUs
    # 8 GPUs * 16 * 2048 = ~262K tokens/step (adjust accumulation for ~1M)
