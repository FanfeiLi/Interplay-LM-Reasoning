#!/bin/bash
# =============================================================================
# TinyStories Pre-training Run Script for ARLM (Next-Token Prediction)
# =============================================================================
# Trains Qwen2ForCausalLM on TinyStories using the same SentencePiece
# tokenizer and data as the DLLM runs, enabling direct comparison.
#
# Usage:
#   bash dllm/examples/tinystories/run_pretrain_ar.sh 100M
#   bash dllm/examples/tinystories/run_pretrain_ar.sh 200M
#   bash dllm/examples/tinystories/run_pretrain_ar.sh 400M
#
...
#   WANDB_PROJECT      W&B project name (default: arlm-tinystories-ngram)
# =============================================================================
...
export WANDB_PROJECT="${WANDB_PROJECT:-arlm-tinystories-ngram}"
...
get_batch_config() {
    local SIZE="$1"
    case "${SIZE}" in
        100M) BATCH_SIZE=16; GRAD_ACCUM=4;  GRAD_CKPT="False" ;;
        200M) BATCH_SIZE=8;  GRAD_ACCUM=8;  GRAD_CKPT="True"  ;;
        400M) BATCH_SIZE=4;  GRAD_ACCUM=16; GRAD_CKPT="True"  ;;
        *)
...
MODEL_CONFIG="${PROJECT_ROOT}/model_configs/qwen2_tinystories_${SIZE}"
...
# =============================================================================
SEED="${SEED:-42}"
RUN_NAME="ar_tinystories_${SIZE}_seed${SEED}_$(date +%Y%m%d_%H%M%S)"
OUTPUT_DIR="${FAST_ROOT}/saves/tinystories/${RUN_NAME}"

echo "=============================================="
echo "Training AR ${SIZE} on TinyStories"
