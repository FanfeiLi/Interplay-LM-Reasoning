# a2d_qwen2_tinystories_100M

A2D-Qwen2 100M config for TinyStories n-gram analysis.
Same architecture as `a2d_qwen2_100M` (12 layers, hidden_size=768),
...
## Key differences from a2d_qwen2_100M

| Field          | a2d_qwen2_100M | a2d_qwen2_tinystories_100M |
|----------------|----------------|----------------------------|
