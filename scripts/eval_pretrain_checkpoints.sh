...
MAMBA_MAX_TOKENS="${MAMBA_MAX_TOKENS:-65536}"
MAMBA_BATCH_SIZE="${MAMBA_BATCH_SIZE:-128}"
MAMBA_MAX_GEN_LEN="${MAMBA_MAX_GEN_LEN:-512}"
...
MTP_MAX_TOKENS="${MTP_MAX_TOKENS:-65536}"
MTP_BATCH_SIZE="${MTP_BATCH_SIZE:-128}"
MTP_MAX_GEN_LEN="${MTP_MAX_GEN_LEN:-512}"
