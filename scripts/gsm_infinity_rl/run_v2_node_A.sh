#!/bin/bash
# =============================================================================
# Node A: Base model eval + GRPO v2 (id, edge, hard)
# Train with outcome reward, eval with process-verified reward
#
# Usage: bash scripts/gsm_infinity_rl/run_v2_node_A.sh
# =============================================================================
...
# ─── Helper: train + eval one run ──────────────────────────────────────────
run_experiment() {
    local CFG="$1"
    local RUN="$2"
    local IDX="$3"
    local TOTAL="$4"
    local RESULTS_DIR="results/gsm_infinity_rl/${RUN}"
...
# ─── Step 1-3: GRPO v2 runs ───────────────────────────────────────────────
run_experiment "grpo_id_v2"   "grpo_id_v2"   "1" "3"
run_experiment "grpo_edge_v2" "grpo_edge_v2" "2" "3"
run_experiment "grpo_hard_v2" "grpo_hard_v2" "3" "3"
...
echo ""
echo "================================================================"
echo "Node A complete! Total wall time: ${HOURS}h ${MINS}m"
echo "================================================================"
echo "Runs completed:"
