#!/bin/bash
# =============================================================================
# GSM-Infinity Pre-training — 400M Transformer (Next-Token Prediction)
# =============================================================================
...
# Effective batch: 16 per GPU × 4 accum × 8 GPUs × 2048 tokens ≈ 1M tokens/step
# =============================================================================
...
# =============================================================================
echo "=============================================="
echo "GSM-Infinity Pre-training — 400M AR / NTP"
echo "=============================================="
...
echo ""
echo "Architecture:"
echo "  hidden_size=1024, num_layers=26, intermediate_size=4096"
echo "  num_heads=16, kv_heads=4  →  ~398M params"
echo ""
echo "Hyperparameters:"
echo "  lr=1e-4, min_lr=3e-5 (cosine), weight_decay=0.1, warmup=5%"
echo "  batch=16/GPU × accum=4 × 8 GPUs × 2048 tokens ≈ 1M tokens/step"
echo ""
...
MODEL_CONFIG="${PROJECT_ROOT}/model_configs/qwen2_400M/config.json"
